        ...
        alert("방 번호를 선택해주세요.")
            ...
            for(var i=0;i<arr.length;i++){
                ...
                $.ajax({
                    ...
                    ,data: {room_type:sec_room.room_type.value,f_day:sec_room.f_day.value,l_day:sec_room.l_day.value,s_day:sec_room.s_day.value,room_name:arr[i],last_field:sec_room.last_field.value,user_name:sec_room.user_name.value,user_id:sec_room.user_id.value,user_phone:sec_room.user_phone.value}
