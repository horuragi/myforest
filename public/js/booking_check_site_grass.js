...
function view_index(data) {
    ...
    let handler = function(name){
        for (var i=0; i<data.result.length; i++) {
            ...
            if(index[1]=="grass"){
	            if ( index.length == 3) {
		        room_index=$("<div class=\"check_info\" style=\"height:40px;line-height:40px\"><div class=\"ui checkbox\" style=\"float:left;width:50%\"><input type=\"checkbox\" name=\"room_index\" value=\""+data.result[i].room_name+"\">"+"<label>"+name+"_"+index[2]+"</label></div><div class=\"ui toggle checkbox\" style=\"float:left;width:50%;\"><input type=\"checkbox\" name=\"solo\" value=\"yes\"><label>두팀사용여부</labe></div></div>").appendTo(target);
	            } else {
		        room_index=$("<div class=\"check_info\" style=\"height:40px;line-height:40px\"><div class=\"ui checkbox\" style=\"float:left;width:50%\"><input type=\"checkbox\" name=\"room_index\" value=\""+data.result[i].room_name+"\">"+"<label>"+name+"_"+index[1]+"</label>/div><div class=\"ui toggle checkbox\" style=\"float:left;width:50%;\"><input type=\"checkbox\" name=\"solo\" value=\"yes\"><label>두팀사용여부</labe></div></div>").appendTo(target);
	            }
            }else{
                if ( index.length == 3) {
        ...
        $('input[type="checkbox"][name="room_index"]').click(function(){
            ...
            for(i=0;i<chkbox.length;i++) {
                if(chkbox[i].checked==true){
                    ...
                    var solo_check=chkbox[i].parentNode.parentNode.childNodes[1].childNodes[0];
        ...
        $('input[type="checkbox"][name="solo"]').click(function(){
            var chkbox = $('input[type="checkbox"][name="room_index"]');
            if(!$(this).is(":checked")){
                $(this).prop('checked', false);
            }else{
