  ...
  let handler = function (name) {
    for (var i = 0; i < data.result.length; i++) {
      ...
      if (index[1] == 'grass') {
        if (index.length == 3) {
          room_index = $(
            '<div class="check_info" style="height:40px;line-height:40px"><div class="ui checkbox" style="float:left;width:50%"><input type="checkbox" name="room_index" value="' +
              ...
              '_' +
              index[2] +
              '</label></div><div class="ui toggle checkbox" style="float:left;width:50%;"><input type="checkbox" name="solo" value="yes"><label>두팀사용여부</labe></div></div>',
          ).appendTo(target);
        } else {
          room_index = $(
            '<div class="check_info" style="height:40px;line-height:40px"><div class="ui checkbox" style="float:left;width:50%"><input type="checkbox" name="room_index" value="' +
