...
function room(res) {
  ...
  if (res.nightingale > 0) {
    ...
    if (datas == '') {
      var room = $(
        '<div id="link"><div class="room"><div class="room_img"><img src="/images/noimage.gif"></div><div class="room_details"><p class="room_title" >[방갈로] 꾀꼬리</p><br><span>전기온돌/냉장고/선풍기/에어컨/야외 테라스</span><br><br><span>예약 가능 좌석  <span >' +
          res.nightingale +
      ...
      var room = $(
        '<div id="link"><div class="room"><div class="room_img"><img src="/camp_image/' +
          arr[0].filename +
          '"></div><div class="room_details"><p class="room_title" >[방갈로] 꾀꼬리</p><br><span>전기온돌/냉장고/선풍기/에어컨/야외 테라스</span><br><br><span>예약 가능 좌석  <span >' +
          res.nightingale +
          '</span><p class="room_price">' +
          res.nightingale_price +
          '</p></div></div></div>',
