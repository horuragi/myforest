...
module.exports = (function () {
  ...
  jsboard.list = function (req, res, board_type) {
    ...
    var listhandler = function (req, res, data) {
      ...
      fs.readFile("./views/" + board_type + "_list.html", "utf-8", function (error, data) {
        ...
        var queryString =
          "select id,subject,contents,user_id,user_name,hits,date_format(reg_date, '%Y-%m-%d') as reg_date from " +
          board_type +
  ...
  jsboard.delete = function (req, res, board_type) {
    ...
    var deletehandler = function (req, res) {
      res.redirect("/community/" + board_type);
    };
  ...
  jsboard.insert = function (req, res, board_type) {
    ...
    var queryString =
      "insert into " + board_type + "(subject,contents,user_id,user_name,hits) values (?,?,?,?,?)";
    ...
    mysql.put(
      ...
      [
        ...
        /*body.user_name*/ req.session.nickname,
        0,
      ],
      req,
      res,
  ...
  jsboard.edit = function (req, res, board_type) {
    ...
    mysql.put(
      queryString,
      [body.subject, body.ir1, req.params.id],
      req,
      res,
      edithandler,
      errhandler
  ...
  jsboard.comment_insert = function (req, res, board_type) {
    ...
    var body = req.body;
    var queryString =
      "insert into " + board_type + "_comment(board_id,comment,user_id,user_name) values (?,?,?,?)";

    var inserthandler = function (req, res) {
      res.redirect("/community/" + board_type + "/detail/" + body.board_id);
    };
  ...
  jsboard.comment_delete = function (req, res, board_type) {
    ...
    var deletehandler = function (req, res) {
      res.redirect("/community/" + board_type + "/detail/" + req.params.board_id);
    };
