...
module.exports = (function () {
  ...
  jsboard.insert = function (req, res, board_type) {
    ...
    mysql.put(
      queryString,
      [body.subject, body.ir1, /* body.user_id */ req.session.userid, /*body.user_name*/ req.session.nickname, 0],
      req,
      res,
      inserthandler,
      errhandler,
  ...
  jsboard.comment_insert = function (req, res, board_type) {
    ...
    mysql.put(
      queryString,
      [body.board_id, body.comment, /* body.user_id */ req.session.userid, /*body.user_name*/ req.session.nickname],
      req,
      res,
      inserthandler,
      errhandler,
