...
module.exports = (function(){
    ...
    if(checkname[0]=="firstetc"||checkname[0]=="secondetc"||checkname[0]=="site"){
            ...
            console.log(config.access_key);
             ...
             request({
                ...
                body: {
                  ...
                  to: [tonumber],
                  content: startday+"~"+endday+" "+result[0].name+"_"+num+solo+" 예약신청완료 입금계좌:농협은행(463131-52-138136)"
                }
                ...
                console.log(response);
                    request({
                      ...
                      body: {
                        ...
                        //to: [tonumber],
                        content: startday+"~"+endday+" "+result[0].name+"_"+num+solo+" 신청자번호:"+tonumber
                      }
                    },function (error, response, body) {
      ...
      res.send("<script>alert(\"예약 신청이 완료되었습니다.\");</script><script>location.href=\"/booking_reservation\"</script>");
    ...
    body: {
      ...
      from: config.owner_phone_number,
      to: [tonumber],
      content: startday+"~"+endday+" "+roomname+solo+" 예약신청완료 입금계좌:농협은행(463131-52-138136)"
    }
  },function (error, response, body) {
    if(error){
      console.log(error);
    ...
    body: {
      ...
      from: config.owner_phone_number,
      to: [tonumber2],
      content: result[0].name+"_"+num+" 예약승인되었습니다.. 내안의 숲에 오신 것을 진심으로 환영합니다.^_^"
    }
  },function (error, response, body) {
