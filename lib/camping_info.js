...
module.exports = (function () {
  ...
  camping_info.get = function (req, res, handler, errhandler) {
    var sql =
      'select * from camping_info inner join (select a.room_type, a.room_peakcharge, a.room_lowcharge, count(b.room_type) as room_cnt from room_detail as a left outer join room_management as b on a.room_type = b.room_type group by a.room_type) as room_detail on camping_info.Field = room_detail.room_type inner join page_info on camping_info.Field = page_info.pagename order by camping_info.id';
