...
var picture_upload = multer({storage:picture_storage,
...
module.exports = (function(){
  ...
  camping_info.get = function(req,res,handler,errhandler){
    var sql = "select * from camping_info inner join room_detail on camping_info.Field = room_detail.room_type inner join page_info on camping_info.Field = page_info.pagename order by camping_info.id;";
  ...
  camping_info.update = function(req,res,handler,errhandler){
   ...
   var sql = "update camping_info a inner join room_detail b on a.Field = b.room_type set a.standnum=?,a.maxnum=?,b.room_peakcharge=?,b.room_lowcharge=?,a.coption=? where a.id=?";
   var data = [req.body.standnum,req.body.maxnum,req.body.peakcharge,req.body.lowcharge,req.body.coption,req.body.id];
