...
router.post('/nightingale',function(req,res,next){
        renderPage = "booking_nightingale_mobile"
          ...
          replaceField(result);
          var idxv=generateidx(req.params.roomtype);
		   res.render(renderPage,{f_day:req.body.f_day, l_day:req.body.l_day, price:req.body.room_price, days:req.body.days, sec_day:req.body.sec_day, "session":req.session,data:result,params:req.params,idx:idxv});
       }
...
router.post('/site_grass',function(req,res,next){
        renderPage = "booking_site_grass_mobile"
          ...
          replaceField(result);
          var idxv=generateidx(req.params.roomtype);
		   res.render(renderPage,{f_day:req.body.f_day, l_day:req.body.l_day, price:req.body.room_price,twoprice:req.body.room_twoprice, days:req.body.days, sec_day:req.body.sec_day, "session":req.session,data:result,params:req.params,idx:idxv});
       }
...
router.post('/booking_reservation',function(req,res,next){
         ...
         var userphone = req.body.userphone;
	       ...
	       res.send("<script>alert(\"이름과 휴대폰번호를 입력해주세요.\");</script><script>location.href=\"/mobile/booking_reservation\";</script>");   
	     }else{
