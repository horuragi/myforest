...
var adarr = home_admin.get_adlist();
	...
	var queryString = 'select * from qna where id = '+req.params.id;
...
var adarr = home_admin.get_adlist();
	...
	var queryString = 'select id,subject,contents,user_id,user_name,hits,date_format(reg_date, \'%Y-%m-%d\') as reg_date from qna where id = '+req.params.id;
 var queryString2 = 'select id,board_id,comment,user_id,user_name,date_format(reg_date, \'%Y-%m-%d\') as reg_date from qna_comment where board_id = '+req.params.id;
